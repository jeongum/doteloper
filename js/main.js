...
var typing = document.getElementById('sec-title');

var typewriter = new Typewriter(typing, {
    loop: true
});

typewriter.typeString('개발자 이정음의 ')
    .typeString('포트폴리오')
    .pauseFor(2500)
    .start();


var about_typing = document.getElementById('about-typing');

var about_typing_writer = new Typewriter(about_typing, {
    loop: true
});

about_typing_writer.typeString('개발자 이정음을 소개합니다.')
    .pauseFor(2500)
    .start();
